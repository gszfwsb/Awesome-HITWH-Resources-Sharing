/* File:     pth_trap_semap.c
 * Purpose:  Estimate trapezoidal area using trapezoidal rule 
 *           This version uses a semaphore to protect the critical section
 * Compile:  gcc -g -Wall -o pth_trap_semap pth_trap_semap.c -lm -lpthread
 *           timer.h needs to be available
 * Run:      ./pth_trap_semap <number of threads> <n> a b
