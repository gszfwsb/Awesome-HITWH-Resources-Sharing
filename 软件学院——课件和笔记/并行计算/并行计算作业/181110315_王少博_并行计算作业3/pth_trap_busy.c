/* File:     pth_trap_busy.c
 * Purpose:  Estimate trapezoidal area using trapezoidal rule 
 *           This version uses busy waiting the critical section
 * Compile:  gcc -g -Wall -o pth_trap_busy pth_trap_busy.c -lm -lpthread
 *           timer.h needs to be available
 * Run:      ./pth_trap_busy <number of threads> <n> a b
