...
public class TouriststoreGUI extends JFrame implements ParticipantGUI {
  ...
  private static File cusFile = new File("ShopCustomer.xml");
  private static File possibleCusFile = new File("ShopPossibleCustomer.xml");


  public TouriststoreGUI(BusinessMediator bMdtr) {
   ...
   class ButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getActionCommand().equals(SUBMIT)) {
		   ...
		   if(cusInfoArr.length < 2){
		   	  System.out.println("You name should contain at least First name and last name with a blank space between them.");
		   	  return;
		   }
           ...
           displayInfo("\n\nTouriststore reserved:\n" + name);
           displayInfo("\n" + id );
           displayInfo("\n" + nation );

           String hotelCus = "\n\nCustomer check in Touriststore:";
